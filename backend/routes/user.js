...
const connexion = require("../middleware/connexion"); // Importation du middleware de limitation de connexion infructueuses
...
router.post("/login", connexion, userCtrl.login); // Route pour la connexion de nouveaux utilisateurs
